...
int gmmreg_api(const char* input_config, const char* method) {
  cout << "Registration performed using code by Jian et al." << endl;
  ...
  // if(!strcmp(method, "TPS_L2")) {
  // cout << "mg_knows that it's TPS L2 witout caps" << endl;
  //}
  // else{
 ...
 //   gmmreg::CoherentPointDriftGrbf().Run(f_config);
   if (!strcmp(method, "TPS_L2")) {
      cout << "Registration method: TPS_L2" << endl;
